...
<div class="container">
  ...
  <li class="nav-item">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h3>Update Purchase Invoice - Ref {{ $inv->invoice_ref}}</h3></div>
                ...
                <div class="card-body">
                    ...
                    <form  action="{{ route('purchases.update',['id' => $inv->invoice_id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                                       ...
                                       <select class="form-control" name="supplier" onchange="submit()">
                                       ...
                                       @endforeach
                                        ...
                                        <br><br>
                                        <h6>Purchase Reference: <input type="text" class="form-control" name="ref_no" value="{{$inv->invoice_ref}}" onchange="submit()"></h6>
                        ...
                        <div class="col-md-4">
                                        ...
                                        <h6>Purchase Date: <input type="text" class="form-control" name="quote_date" value="{{$inv->invoice_date}}" onchange="submit()"></h6>
                                        <h6>Purchase Due: <input type="text" class="form-control" name="due_date" value="{{$inv->invoice_due}}" onchange="submit()"></h6>
